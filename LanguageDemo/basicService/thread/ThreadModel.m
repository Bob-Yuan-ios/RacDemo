...
//        2021-08-09 16:44:32.022665+0800 LanguageDemo[20878:325180] ===========Time:0.151102

//        dispatch_semaphore_t semaphore_t = dispatch_semaphore_create(1);
//        dispatch_semaphore_wait(semaphore_t, DISPATCH_TIME_FOREVER);
//        dispatch_semaphore_signal(semaphore_t);
//        2021-08-09 16:49:46.795690+0800 LanguageDemo[20941:328919] ===========Time:0.160759

//        pthread_mutex_t mutex = PTHREAD_MUTEX_INITIALIZER;
//        pthread_mutex_lock(&mutex);
//        pthread_mutex_unlock(&mutex);
//        2021-08-09 16:52:55.179425+0800 LanguageDemo[21020:333999] ===========Time:0.223802

//        NSLock *testlock = [[NSLock alloc] init];
//        [testlock lock];
//        [testlock unlock];
//        2021-08-09 16:54:08.381847+0800 LanguageDemo[21056:336456] ===========Time:0.254232
