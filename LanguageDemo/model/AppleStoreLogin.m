...
#import "AppleStoreLogin.h"
#import <AuthenticationServices/AuthenticationServices.h>

@interface AppleStoreLogin ()
<
...
@implementation AppleStoreLogin
...
- (void)configUI{
    ...
    if (@available(iOS 13.0, *)) {
        ...
        ASAuthorizationAppleIDButton *appleIDBtn = [ASAuthorizationAppleIDButton
                                                    buttonWithType:ASAuthorizationAppleIDButtonTypeDefault
                                                    style:ASAuthorizationAppleIDButtonStyleWhite];
        appleIDBtn.frame = CGRectMake(30,
                                      _vc.view.bounds.size.height - 180,
                                      _vc.view.bounds.size.width - 60,
                                      100);
        ...
        [_vc.view addSubview:appleIDBtn];
    }else{
        // 或者自己用UIButton实现按钮样式
        UIButton *addBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        addBtn.frame = CGRectMake(30, 80, _vc.view.bounds.size.width - 60, 44);
        addBtn.backgroundColor = [UIColor orangeColor];
        [addBtn setTitle:@"Sign in with Apple" forState:UIControlStateNormal];
        [addBtn addTarget:self action:@selector(handleAuthorizationAppleIDButtonPress) forControlEvents:UIControlEventTouchUpInside];
        [_vc.view addSubview:addBtn];
    }
}
